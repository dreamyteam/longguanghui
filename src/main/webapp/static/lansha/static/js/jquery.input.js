/**
 * Created by FE TEAM on 2015/11/27.
 * 要替换的input需要定宽高
 *  check.a(
 {
...
var check = {
    ...
    hasHidePlaceholder: function (bindName, type) {
        ...
        check.hide_placeholder();
        $(document).on(type,bindName, function () {
            $("input").each(function () {
                if ($(this).is(":visible")) {
                    $(this).attr("data-visible", 1);
                } else {
